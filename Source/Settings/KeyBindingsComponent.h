...
private:
    ...
    float delayButtonBounds[7][4] = { {0.191,0.555,0.015,0.025} ,{0.191,0.63,0.015,0.025} ,{0.282,0.588,0.075,0.1} , {0.452,0.588,0.075,0.1}, {0.5975,0.6,0.04,0.06},
                                      {0.6825,0.6,0.04,0.06} ,{0.744,0.615,0.015,0.025} };
